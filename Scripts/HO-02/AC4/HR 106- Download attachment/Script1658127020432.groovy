...
// Upload file
WebUI.uploadFile(findTestObject('Page_OrangeHRM/input_Select File_ufile'), RunConfiguration.getProjectDir() + '\\File\\1.png')
...
WebUI.click(findTestObject('Page_OrangeHRM/a_download.png'))

//CustomKeywords.'keywords.FileDownloaded.isFileDownloaded'('C:\\Users\\ctthi\\Katalon Studio\\Download', '999')
