...
WebUI.click(findTestObject('Page_OrangeHRM/input_Attachments_btnDeleteAttachment'))

WebUI.check(findTestObject('Page_OrangeHRM/Page_OrangeHRM/input_Attachments_CheckAll'))
